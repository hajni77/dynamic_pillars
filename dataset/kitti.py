...
class Kitti(Dataset):
    ...
    def __init__(self, data_root, split, pts_prefix='velodyne_reduced'):
        ...
        self.data_aug_config=dict(
            ...
            object_noise=dict(
                num_try=100,
                # translation_std=[0.25, 0.25, 0.25], # decrease the translation_std, pslidar have more noise
            ...
            point_range_filter=[0, -39.68, -3, 69.12, 39.68, 1],#LIDAR
            object_range_filter=[0, -39.68, -3, 69.12, 39.68, 1]  #LIDAR
            # point_range_filter=[5.33, -13.77, -1.9, 72.4943, 18.3772, 1],#pseudo-LIDAR
            # object_range_filter=[5.33, -13.77, -1.9, 72.4943, 18.3772, 1]  #pseudo-LIDAR           
        )
