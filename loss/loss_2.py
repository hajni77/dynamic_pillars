...
class Loss(nn.Module):
    def __init__(self, alpha=0.25, gamma=2.0, beta=1/9, cls_w=1.0, reg_w=2.0, dir_w=0.2):
        ...
        self.class_weights = torch.tensor([0.4,0.4,0.2])  # Example: [Car, Pedestrian, Cyclist]
    ...
    def forward(self,
        ...
        # Apply class weights 
        class_weights = self.class_weights[batched_labels.argmax(dim=1)] 
        cls_loss = cls_loss * class_weights.unsqueeze(1)
