...
class _Voxelization(torch.autograd.Function):
    ...
    def forward(ctx,
        ...
        end_time = time.time()
        # print(f"Voxelization time: {end_time - start_time:.4f} seconds")
        
        # # Count and print the number of empty pillars
        # empty_pillars = (num_points_per_voxel_out == 0).sum().item()
        # print("Number of pillars: ", len(voxels))
        # print("Voxel valid: ", voxel_num)
