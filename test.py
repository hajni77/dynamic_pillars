...
def main(args):
    ...
    camera_bboxes=result_filter['camera_bboxes']
    bboxes2d=result_filter['bboxes2d']
    # save result
    
    os.makedirs(args.result)
    np.save(os.path.join(args.result, 'bboxes.npy'), lidar_bboxes)
    np.save(os.path.join(args.result, 'labels.npy'), labels)
    np.save(os.path.join(args.result, 'scores.npy'), scores)
    np.save(os.path.join(args.result, 'bboxes2d.npy'), bboxes2d)
    np.save(os.path.join(args.result, 'camera_bboxes.npy'), camera_bboxes)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--result', default='result_test')  
